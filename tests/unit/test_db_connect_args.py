...
def test_async_sqlite_gets_check_same_thread():
    assert async_connect_args_for("sqlite+aiosqlite:///./data/xillion.db") == {
...
def test_async_postgres_gets_encrypted_but_unverified_ssl_and_disables_statement_cache():
    ...
    url = (
        "postgresql+asyncpg://postgres.abcxyz:pw@aws-0-ap-south-1.pooler.supabase.com:5432/postgres"
    )
